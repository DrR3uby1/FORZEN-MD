...
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? 'DR-R3UBY MD' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'DR R3UBY ROBOTS 🤖' : process.env.OWNER_NAME,
  sessionName:  process.env.SESSION_ID === undefined ? false : process.env.SESSION_ID,
  author:  process.env.PACK_INFO.split(";")[0] === undefined ? 'DR R3UBY ROBOTS 🤖' : process.env.PACK_INFO.split(";")[0],
